      ...
      <aside>
        <div id="sidebar" class="nav-collapse">
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li >
              <a href="index.php?tp=ocean&action=imgindex" class="">
                <i class="fa fa-photo">
                </i>
                <span>
                 图文浏览
                        ...
                        <div class="panel-body">
                           <form class="form-horizontal" role="form">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-lg-9">
                                    <select class="form-control m-bot15" style="color:black;"   name="tp_id" id="tp_tid" onchange="getPoint(this);">
                                       <?php echo $select;?>
                                    </select>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-lg-9">
                                    <select class="form-control m-bot15" name="gid" id="gid"  onchange="getPrice(this)" style="color:black;" >
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-lg-9">
                                    <div class="iconic-input right">
                                       ...
                                       <input type="text" class="form-control"  name="need" id="need" disabled>
                                    </div>
                                 </div>
                              </div>
